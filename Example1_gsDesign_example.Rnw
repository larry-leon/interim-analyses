...
algorithm with a ramp-up phase.  Default censoring is exponential.  Survival times are generating according to Weibull distributions 
...
# 10,000 takes ~ 35 minutes on my workstation
# Approximately 3.5 minutes per 1,000 simulations 
